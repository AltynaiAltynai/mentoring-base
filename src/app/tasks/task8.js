...
const answer1 = data.map(user => ({
    id: user.id,
    username: user.username
  }));
  console.log({answer1});
  
const answer2 = data.map(user => user.email);
  console.log("Список emails: ", answer2);

const answer3 = data.find(user => user.id === 9);
  console.log("Пользователи с id=9: ", answer3);

const answer4 = data.filter(user => user.city === 'Lebsackbury');
  console.log("Пользователи с Lebsackbury; ", answer4);

const answer5 = data.slice(0, 4);
console.log("первые пять пользователей: ", answer5);
...
const answer8 = data.map(user => user.website).filter(website => website.includes('.com'));
console.log({answer8});

const answer9 = data.map(user => user.username).filter(username.length > 12);
console.log({answer9});

const answer10 = data.map(user => user.username.toLowerCase);
